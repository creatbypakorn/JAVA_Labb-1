...
ANSWER = answer2, "Replace this text with the variable holding the answer.";
...
ANSWER = reply, "Replace this text with the variable holding the answer.";
 ...
 */
 ...
 let dealer2 = 6;
 let dealer3 = 7;
 let alldealer = dealer1 + dealer2 + dealer3; 
 ...
 } else if ( alldealer >= 17 && alldealer <= 20 ) {
...
ANSWER = retort, "Replace this text with the variable holding the answer.";
 ...
 */
 ...
 switch (myFruit) {
    ...
    case 'banana': 
    counter = 'The Banan is yellow.';
    break;

    case 'apple': 
    counter = 'The apple is green.';
    break;

    case 'kiwi': 
    counter = 'the kiwi is green.';
    break;

    case 'plum':
    counter = 'The plum is purple.';
    break;
...
ANSWER = counter, "Replace this text with the variable holding the answer.";
...
switch (myFruit1) {
   ...
   case 'banana': 
   counter1 = 'The Banan is yellow.';
   break;

   case 'apple': 
   counter1 = 'The apple is green.';
   break;

   case 'kiwi': 
   counter1 = 'the kiwi is green.';
   break;

   case 'plum':
   counter1 = 'The plum is purple.';
   break;

   default: 
   counter1 = 'That is an unknown fruit.';
...
ANSWER = counter1, "Replace this text with the variable holding the answer.";
...
ANSWER = numnum, "Replace this text with the variable holding the answer.";
...
ANSWER =  sumsum, "Replace this text with the variable holding the answer.";
 ...
 */
 ...
 let range = 22;
 for (var items = 24; items < 45; items += 2) {
    range += ',' + items;
 }


ANSWER = range, "Replace this text with the variable holding the answer.";
...
ANSWER = pass, "Replace this text with the variable holding the answer.";
...
while (_number1_ > _number2_) {
    _svaret_++;
    _number1_ = _number1_ - 8;
}

ANSWER = _svaret_, "Replace this text with the variable holding the answer.";
...
var length = resultat.slice(0,resultat.length - 1);
